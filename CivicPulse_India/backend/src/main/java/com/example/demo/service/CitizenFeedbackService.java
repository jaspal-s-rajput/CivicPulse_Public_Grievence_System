...
//                .build();
        ...
        feedback.setResolutionStatus(request.getResolutionStatus());
        feedback.setTimeliness(request.getTimeliness());
        feedback.setOfficerBehaviourRating(request.getOfficerBehaviourRating());
        feedback.setFeedbackComment(request.getFeedbackComment());
        feedback.setReopened(request.getReopened());
        feedback.setFeedbackSubmittedAt(LocalDateTime.now());
        feedback.setFeedbackBy(citizen);
