...
//    }
    ...
    private CitizenComplaintResponse mapToCitizenResponse(Complaint c) {
        ...
        CitizenComplaintResponse response = new CitizenComplaintResponse();
        ...
        response.setAdminRemark(c.getAdminRemark());
        response.setOfficerEvidenceUrl(c.getOfficerEvidenceUrl());
  ...
  public Citizen getCitizenProfile(String email) {
    return citizenRepository.findProfileByEmail(email)
