        ...
        List<OfficerWorkloadResponse> workload =
                officerRepository.findAll()
                        ...
                        .map(officer -> {
                            ...
                            long active = complaintRepository
                                    .countActiveComplaintsByOfficer(officer.getId());
                            ...
                            OfficerWorkloadResponse response = new OfficerWorkloadResponse();
                            ...
                            response.setActiveComplaints(active);
